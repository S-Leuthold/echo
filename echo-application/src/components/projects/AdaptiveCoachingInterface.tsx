/**
 * AdaptiveCoachingInterface Component
 * 
 * Main interface component that orchestrates the adaptive expert coaching conversation.
...
interface AdaptiveCoachingInterfaceProps {
...
/**
 * Main adaptive coaching interface component
 */
export const AdaptiveCoachingInterface: React.FC<AdaptiveCoachingInterfaceProps> = ({
  config = {},
  onProjectCreated,
  onCancel,
  ...
  return (
    <div className={`adaptive-coaching-interface max-w-4xl mx-auto ${className}`}>
      {/* Header with stage indicator */}
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-2xl font-bold text-gray-900">
            Adaptive Project Coaching
          </h2>
          {onCancel && (
            <button
...
export default AdaptiveCoachingInterface;