...
import { UnifiedProjectCreator } from '@/components/projects/UnifiedProjectCreator';
...
export default function ProjectsPage() {
  ...
  // Handle unified creator success
  const handleUnifiedCreatorSuccess = (projectId: string) => {
    console.log('Project created successfully via AI consultant:', projectId);
    // Refresh the projects list to show the new project
    refreshProjects();
  };
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex items-center gap-3">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <DropdownMenuItem 
                    onClick={() => setIsUnifiedCreatorOpen(true)}
                    className="gap-2 cursor-pointer"
                  >
                    <Sparkles className="w-4 h-4 text-accent" />
                    <div className="flex flex-col gap-1">
                      <span className="font-medium">AI Consultant</span>
                      <span className="text-xs text-muted-foreground">Natural conversation with live brief</span>
                    </div>
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
      ...
      <div className="container mx-auto px-6 py-6">
        ...
        {/* Unified AI Project Creator */}
        <UnifiedProjectCreator
          isOpen={isUnifiedCreatorOpen}
          onClose={() => setIsUnifiedCreatorOpen(false)}
          onSuccess={handleUnifiedCreatorSuccess}
        />
