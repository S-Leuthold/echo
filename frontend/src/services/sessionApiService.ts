...
import {
  ...
  GetRelatedSessionsRequest,
  GetRelatedSessionsResponse,
  SessionHistoryItem,
  ApiError,
  ApiResponse,
  RequestOptions,
...
const GetRecentSessionsResponseSchema = z.object({
...
const GetRelatedSessionsResponseSchema = z.object({
  sessions: z.array(SessionHistoryItemSchema),
  metadata: z.object({
    total_found: z.number(),
    relevance_score: z.number(),
    search_criteria: z.string()
  })
});
...
*Note: This is mock session data for development purposes.*`,
  ...
  static async getRecentSessions(limit: number = 5): Promise<GetRecentSessionsResponse> {
    ...
    const mockSessions: SessionHistoryItem[] = [
      // Most Recent - Today
      {
        ...
        title: "echo | API Integration",
        emoji: "🔌",
        snippet: "Completed Phase 1 of session API integration. All mock data replaced with real endpoints, auto-save working perfectly. Ready for Phase 2 session cards...",
        noteCount: 8,
        tasksCompleted: 4,
        totalTasks: 4,
        timeCategory: "DEEP_WORK",
        blockId: "echo-api-01-26",
        duration: 150,
        project: "echo | Platform Development",
        hasNotes: true,
        executiveSummary: "Successfully integrated Phase 1 session API endpoints with robust error handling and graceful fallbacks. All mock data functionality preserved while establishing foundation for real-time session management.",
        aiKeywords: ["FastAPI", "Integration", "Endpoints"]
      },
      {
        id: "recent-2",
        date: "2025-07-27",
        timeRange: "11:00 - 11:30",
        title: "echo | Sprint Planning",
        emoji: "📋",
        snippet: "**Agenda:** Phase 2 roadmap, session cards design, project integration\n\n**Notes:** Team aligned on SpinUpState design as north star. Project-based session organization approved...",
        noteCount: 3,
        tasksCompleted: 2,
        totalTasks: 3,
        timeCategory: "MEETINGS",
        blockId: "sprint-planning-01-27",
        executiveSummary: "Strategic alignment meeting establishing SpinUpState echo insights panel as design north star for Phase 2 session cards. Confirmed project-based organization approach and realistic mock data strategy.",
        aiKeywords: ["Sprint Planning", "Roadmap", "Design System"],
        duration: 30,
        project: "echo | Platform Development",
        attendees: ["Sam", "Alex", "Jordan"],
        hasNotes: true
      },
      {
        id: "recent-3",
        ...
        totalTasks: 1,
        timeCategory: "HEALTH",
        blockId: "workout-01-26",
        duration: 30,
        hasNotes: false,
        executiveSummary: "Personal time - no notes available for health and wellness activities.",
        aiKeywords: []
      },
      // Yesterday
      {
        ...
        title: "MAOM-N | Chapter Revision",
        emoji: "📝",
        snippet: "Major breakthrough on the methodology section. The new framework clearly articulates the relationship between phenomenology and computational methods...",
        noteCount: 12,
        tasksCompleted: 3,
        totalTasks: 4,
        timeCategory: "DEEP_WORK",
        blockId: "maom-revision-01-25",
        duration: 180,
        project: "MAOM-N | Manuscript Revision",
        hasNotes: true,
        executiveSummary: "Achieved significant conceptual breakthrough in methodology section, successfully bridging phenomenological and computational approaches. Framework now provides clear theoretical foundation for empirical work.",
        aiKeywords: ["Methodology", "Phenomenology", "Framework"]
      },
      {
        id: "recent-5",
        date: "2025-07-26",
        timeRange: "13:00 - 14:00",
        title: "Admin | Email Processing",
        emoji: "📧",
        snippet: "Cleared inbox to zero. Key actions: responded to journal reviewer feedback, scheduled three follow-up meetings, filed expense reports...",
        noteCount: 5,
        tasksCompleted: 8,
        executiveSummary: "Highly productive administrative session achieving inbox zero and clearing multiple outstanding action items. Strong progress on reviewer feedback and meeting coordination.",
        aiKeywords: ["Email", "Admin", "Reviews"],
        totalTasks: 10,
        timeCategory: "ADMIN",
        blockId: "admin-01-25",
        duration: 60,
      ...
      },
      {
        ...
        duration: 60,
        hasNotes: false,
        executiveSummary: "Personal time - no notes available for personal activities.",
        aiKeywords: []
      },
      // Additional meeting examples
      {
        id: "recent-7",
        date: "2025-01-24",
        timeRange: "16:30 - 17:30",
        title: "MAOM-N | Advisor Meeting",
        emoji: "🎓",
        snippet: "**Agenda:** Chapter 3 review, methodology validation, next steps\n\n**Notes:** Dr. Smith provided excellent feedback on the phenomenological framework. Suggested three additional papers for literature review. Ready to proceed with final revisions...",
        noteCount: 6,
        tasksCompleted: 2,
        totalTasks: 4,
        timeCategory: "MEETINGS",
        blockId: "advisor-meeting-01-24",
        duration: 60,
        project: "MAOM-N | Manuscript Revision",
      ...
      },
      {
        ...
        emoji: "☕",
        snippet: "**Agenda:** Weekly progress, blockers, research direction\n\n**Notes:** Good progress on Claude API integration patterns. Maria shared insights on cost optimization. Planning deep dive session on session intelligence approaches...",
        noteCount: 4,
        tasksCompleted: 1,
        totalTasks: 2,
        timeCategory: "MEETINGS",
        blockId: "research-standup-01-23",
        duration: 30,
        project: "Research | AI Integration",
        attendees: ["Maria", "David", "Sarah", "Alex"],
        hasNotes: true
      }
    ];
    ...
    return {
      ...
      metadata: {
        ...
        date_range: "2025-07-25 to 2025-07-27",
        last_updated: new Date().toISOString()
      }
    };
  }

  static async getRelatedSessions(request: GetRelatedSessionsRequest): Promise<GetRelatedSessionsResponse> {
    await new Promise(resolve => setTimeout(resolve, 600));
    
    // All sessions grouped by project for realistic related session matching
    const allProjectSessions: SessionHistoryItem[] = [
      // echo | Platform Development sessions
      {
        id: "echo-1",
        date: "2025-01-24",
        timeRange: "09:00 - 12:00",
        title: "echo | Timer & Styling Fixes",
        emoji: "🔧",
        snippet: "Fixed ActiveSessionState timer accuracy - now uses real block duration instead of hardcoded 2 hours. Updated action checklist styling to match SpinUpState echo insights panel...",
        noteCount: 6,
        tasksCompleted: 3,
        totalTasks: 3,
        timeCategory: "DEEP_WORK",
        blockId: "echo-fixes-01-24",
        duration: 180,
        project: "echo | Platform Development",
        hasNotes: true
      },
      {
        ...
        title: "echo | Session State Architecture",
        emoji: "🏗️",
        snippet: "Major refactor of session state management. Implemented comprehensive error boundaries and recovery mechanisms. Auto-save functionality working smoothly...",
        noteCount: 11,
        tasksCompleted: 5,
        totalTasks: 6,
        timeCategory: "DEEP_WORK",
        blockId: "echo-architecture-01-23",
        duration: 180,
        project: "echo | Platform Development",
        hasNotes: true
      },
      {
        ...
        title: "echo | UI Component System",
        emoji: "🎨",
        snippet: "Built the foundation components with shadcn/ui. Established design system consistency across SpinUp, Active, and Tranquil states. Color system refinements...",
        noteCount: 9,
        tasksCompleted: 4,
        totalTasks: 5,
        timeCategory: "DEEP_WORK",
        blockId: "echo-ui-01-22",
        duration: 180,
        project: "echo | Platform Development",
        hasNotes: true
      },
      {
        ...
        title: "echo | Database Schema Design",
        emoji: "🗄️",
        snippet: "Designed session intelligence database schema. Comprehensive mock data foundation for Claude integration. Session persistence and analytics structure...",
        noteCount: 7,
        tasksCompleted: 3,
        totalTasks: 4,
        timeCategory: "DEEP_WORK",
        blockId: "echo-db-01-21",
        duration: 150,
        project: "echo | Platform Development",
        hasNotes: true
      },

      // MAOM-N | Manuscript Revision sessions
      {
        id: "maom-1",
        date: "2025-01-24",
        timeRange: "08:00 - 11:00",
        title: "MAOM-N | Literature Review",
        emoji: "📚",
        snippet: "Deep dive into phenomenological approaches to computational methodology. Found three key papers that perfectly frame our argument. The Dreyfus critique needs addressing...",
        noteCount: 15,
        tasksCompleted: 2,
        totalTasks: 3,
        timeCategory: "DEEP_WORK",
        blockId: "maom-lit-01-24",
        duration: 180,
        project: "MAOM-N | Manuscript Revision",
        hasNotes: true
      },
      {
        ...
        title: "MAOM-N | Methodology Chapter",
        emoji: "⚙️",
        snippet: "Breakthrough on the methodology section! The hybrid framework clearly articulates how phenomenological analysis can inform computational approaches. Ready for peer review...",
        noteCount: 18,
        tasksCompleted: 4,
        totalTasks: 4,
        timeCategory: "DEEP_WORK",
        blockId: "maom-method-01-23",
        duration: 180,
        project: "MAOM-N | Manuscript Revision",
        hasNotes: true
      },
      {
        id: "maom-3",
        date: "2025-01-22",
        timeRange: "06:30 - 09:30",
        title: "MAOM-N | Results Analysis",
        emoji: "📊",
        snippet: "Statistical analysis complete. The correlation between phenomenological themes and computational patterns is stronger than expected. Need to revise hypothesis section...",
        noteCount: 12,
        tasksCompleted: 3,
        totalTasks: 5,
        timeCategory: "DEEP_WORK",
        blockId: "maom-results-01-22",
        duration: 180,
        project: "MAOM-N | Manuscript Revision",
        hasNotes: true
      },

      // PersonalSite | Portfolio Redesign sessions
      {
        id: "portfolio-1",
        date: "2025-01-24",
        timeRange: "19:00 - 21:00",
        title: "PersonalSite | Design System",
        emoji: "🎯",
        snippet: "Established design system based on echo learnings. Typography hierarchy, color palette, and component structure. Using Tailwind for consistency...",
        noteCount: 5,
        tasksCompleted: 2,
        totalTasks: 4,
        timeCategory: "DEEP_WORK",
        blockId: "portfolio-design-01-24",
        duration: 120,
        project: "PersonalSite | Portfolio Redesign",
        hasNotes: true
      },
      {
        id: "portfolio-2",
        ...
        title: "PersonalSite | Content Strategy",
        emoji: "✍️",
        snippet: "Content audit complete. Focus on showcasing echo project, MAOM-N research, and technical expertise. Case study format for project presentations...",
        noteCount: 4,
        tasksCompleted: 3,
        totalTasks: 3,
        timeCategory: "DEEP_WORK",
        blockId: "portfolio-content-01-23",
        duration: 120,
        project: "PersonalSite | Portfolio Redesign",
        hasNotes: true
      },

      // Research | AI Integration sessions
      {
        id: "research-1",
        date: "2025-01-24",
        timeRange: "16:00 - 18:00",
        title: "Research | Claude API Patterns",
        emoji: "🤖",
        snippet: "Studied Claude API integration patterns across different applications. Key insights on structured outputs, error handling, and cost optimization strategies...",
        noteCount: 8,
        tasksCompleted: 2,
        totalTasks: 3,
        timeCategory: "RESEARCH",
        blockId: "research-claude-01-24",
        duration: 120,
        project: "Research | AI Integration",
        hasNotes: true
      },
      {
        ...
        title: "Research | Session Intelligence",
        emoji: "🧠",
        snippet: "Explored session intelligence approaches. LLM-powered session analysis, pattern recognition, and predictive scheduling. Promising avenues for echo integration...",
        noteCount: 10,
        tasksCompleted: 1,
        totalTasks: 2,
        timeCategory: "RESEARCH",
        blockId: "research-intelligence-01-22",
        duration: 150,
        project: "Research | AI Integration",
        hasNotes: true
      }
    ...
    let filteredSessions = allProjectSessions;
    
    // Primary filter: exact project match
    if (request.projectContext) {
      filteredSessions = filteredSessions.filter(s => s.project === request.projectContext);
    }
    
    // Secondary filter: time category
    if (request.timeCategory) {
      filteredSessions = filteredSessions.filter(s => s.timeCategory === request.timeCategory);
    }
    ...
    return {
      ...
      metadata: {
        total_found: filteredSessions.length,
        relevance_score: 0.90,
        search_criteria: `project: ${request.projectContext || 'any'}, timeCategory: ${request.timeCategory || 'any'}`
      }
    };
  }
}
...
export class SessionApiService {
  ...
  async getRecentSessions(
    limit: number = 5,
    options: RequestOptions = {}
  ): Promise<ApiResponse<GetRecentSessionsResponse>> {
    const cacheKey = `recent-sessions-${limit}`;
    
    // Check cache first
    if (this.config.enableCache && options.cacheable !== false) {
      const cached = this.cache.get<GetRecentSessionsResponse>(cacheKey);
      if (cached) {
        return {
          success: true,
          data: cached,
    ...
    const operation = () => this.makeRequest<GetRecentSessionsResponse>(
      '/sessions/recent',
      {
        method: 'GET',
        requestId: `recent-sessions-${Date.now()}`
      },
      GetRecentSessionsResponseSchema
    );

    const fallback = () => MockFallbackService.getRecentSessions(limit);
    const result = await this.withRetry(operation, `recent-sessions-${Date.now()}`, fallback);
    
    // Cache successful results
    if (result.success && result.data) {
      this.cache.set(cacheKey, result.data, CACHE_DURATIONS.session);
    }
  ...
  /**
   * Get related sessions based on context
   */
  async getRelatedSessions(
    request: GetRelatedSessionsRequest,
    options: RequestOptions = {}
  ): Promise<ApiResponse<GetRelatedSessionsResponse>> {
    const cacheKey = `related-sessions-${JSON.stringify(request)}`;
    
    // Check cache first
    if (this.config.enableCache && options.cacheable !== false) {
      const cached = this.cache.get<GetRelatedSessionsResponse>(cacheKey);
      if (cached) {
        return {
          success: true,
          data: cached,
    ...
    const operation = () => this.makeRequest<GetRelatedSessionsResponse>(
      '/sessions/related',
      {
        method: 'POST',
        body: JSON.stringify(request),
        requestId: `related-sessions-${Date.now()}`
      },
      GetRelatedSessionsResponseSchema
    );

    const fallback = () => MockFallbackService.getRelatedSessions(request);
    const result = await this.withRetry(operation, `related-sessions-${Date.now()}`, fallback);
  ...
  /**
   * Save session notes (for auto-save functionality)
   */
  async saveSessionNotes(
    ...
    checklist: any[],
    options: RequestOptions = {}
  ): Promise<ApiResponse<{ saved: boolean; timestamp: string }>> {
    const operation = () => this.makeRequest<{ saved: boolean; timestamp: string }>(
      '/session/notes',
      {
        method: 'POST',
        body: JSON.stringify({
        ...
        requestId: `save-notes-${sessionId}`
      }
    );

    // No fallback for notes saving - we want to know if it fails
    return this.withRetry(operation, `save-notes-${sessionId}`);
  }
